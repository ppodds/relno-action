...
const macros_1 = __nccwpck_require__(5144);
...
const expression_evaluator_1 = __nccwpck_require__(1680);
class Generator {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const generator_1 = __nccwpck_require__(4823);
const log_1 = __nccwpck_require__(8453);
const config_1 = __nccwpck_require__(7836);
const core_1 = __nccwpck_require__(7954);
function run() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const generator = new generator_1.Generator(log, {
                template: (_a = config.template) !== null && _a !== void 0 ? _a : "",
